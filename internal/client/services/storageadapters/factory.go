...
func (f Factory) ORMPasswordsAdapter(s interfaces.Storage[orm.PasswordItem]) Storage[e.PasswordItem] {
...
func (f Factory) ORMNotesAdapter(s interfaces.Storage[orm.NoteItem]) Storage[e.NoteItem] {
...
func (f Factory) ORMBankCardAdapter(s interfaces.Storage[orm.BankCardItem]) Storage[e.BankCardItem] {
...
func (f Factory) ORMUserAdapter(s interfaces.Storage[orm.User]) Storage[e.User] {
